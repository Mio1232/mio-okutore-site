...
▼ EA未使用 + 連敗・損失発言 → みやびEAを優しく紹介
▼ EA使用中 + 連敗発言 → EA設定の見直しを提案
▼ インジ未使用 + 判断難しい発言 → Solid Edgeを紹介
▼ インジ使用中 + 判断難しい発言 → インジの復習を提案
▼ コミュニティ未参加 → LINE「億トレ」案内
▼ Discord参加中 → 配信参加を促す
...
「○○さん、ご興味ありがとうございます🌸
 ...
 LINE:https://liff.line.me/2009118446-ZPutgCO0/landing?follow=%40161qazcj&lp=BGfQ1J&liff_id=2009118446-ZPutgCO0」
...
3. 興味を示したサインがあれば、必ずLINE誘導
   - 質問への直接回答 + LINE誘導の二段構え

4. LINEのリンクは毎回必ず記載する
   (ユーザーがコピペできるように)

5. キーワード「EA詳細希望」「インジ詳細希望」「システム詳細希望」を
